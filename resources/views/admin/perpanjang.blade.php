                        ...
                        <tbody>
                            @foreach ($perpanjangs as $data)
                                ...
                                Download
                                    ...
                                    <td>
                                        @if ($data->lengkap >= 30)
                                            <a href="/admin/perpanjang/download/{{ $data->email }}" target="_blank"
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content p-t-30">
                            <div class="tab-pane active" id="{{ $data->surat_kemenkumham }}" role="tabpanel">
                                ...
                                <form method="post" action="{{ route('admin.perpanjang.update') }}"
                                    class="float-material form-material" enctype="multipart/form-data">
                                    @csrf
                                    @foreach ($dataperpanjang as $menudata)
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_pendaftaran) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ $data->email . '/perpanjangan/' . $data->surat_pendaftaran }}">

                                                                        <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_pendaftaran) }}"
                                                                            alt=""
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset($data->email . '/perpanjangan/' . $data->akte_pendirian) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ $data->email . '/perpanjangan/' . $data->akte_pendirian }}">

                                                                        <img src="{{ asset($data->email . '/perpanjangan/' . $data->akte_pendirian) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset($data->email . '/perpanjangan/' . $data->adrt) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ $data->email . '/perpanjangan/' . $data->adrt }}">

                                                                        <img src="{{ asset($data->email . '/perpanjangan/' . $data->adrt) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset($data->email . '/perpanjangan/' . $data->tujuan) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ $data->email . '/perpanjangan/' . $data->tujuan }}">

                                                                        <img src="{{ asset($data->email . '/perpanjangan/' . $data->tujuan) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_keputusan) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ $data->email . '/perpanjangan/' . $data->surat_keputusan }}">

                                                                        <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_keputusan) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                            ...
                            <div class="tab-pane" id="{{ $data->surat_pendaftaran }}" role="tabpanel">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->biodata_pengurus) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->biodata_pengurus }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->biodata_pengurus) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->ktp) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->ktp }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->ktp) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->foto) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->foto }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->foto) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_keterangan_domisili) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_keterangan_domisili }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_keterangan_domisili) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->npwp) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->npwp }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->npwp) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->foto_kantor) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->foto_kantor }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->foto_kantor) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                @if (!empty($data->keabsahan_kantor))
                                    ...
                                    */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->keabsahan_kantor) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->keabsahan_kantor }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->keabsahan_kantor) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                @if (!empty($data->surat_memuat))
                                    ...
                                    */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_memuat) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_memuat }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_memuat) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_kesediaan) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_rekom_kesediaan }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_kesediaan) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                            ...
                            <div class="tab-pane" id="{{ $data->adrt }}" role="tabpanel">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kepercayaan) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kepercayaan }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kepercayaan) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_agama) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_rekom_agama }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_agama) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kerja) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kerja }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kerja) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_izasah) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_izasah }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_izasah) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->stlk) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->stlk }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->stlk) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                ...
                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->email . '/perpanjangan/' . $data->surat_kemenkumham) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->email . '/perpanjangan/' . $data->surat_kemenkumham }}">

                                                                    <img src="{{ asset($data->email . '/perpanjangan/' . $data->surat_kemenkumham) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_kemenkumham }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_kemenkumham) }}"></object>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_pendaftaran }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /> -->
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_pendaftaran) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->adrt }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /> -->
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->adrt) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->ktp }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /> -->
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->ktp) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->keabsahan_kantor }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /> -->
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->keabsahan_kantor) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->tujuan }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->tujuan) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_keputusan }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_keputusan) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->biodata_pengurus }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->biodata_pengurus) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->foto }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->foto) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_keterangan_domisili }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_keterangan_domisili) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->npwp }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->npwp) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->foto_kantor }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->foto_kantor) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_ketertiban }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_ketertiban) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_tidak_avilasi }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_tidak_avilasi) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_konflik }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_konflik) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_hak_cipta }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_hak_cipta) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_laporan }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_laporan) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_absah }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_absah) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_rekom_agama }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_agama) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kepercayaan }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kepercayaan) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kerja }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_skpd_kerja) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_rekom_kesediaan }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_rekom_kesediaan) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_izasah }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_izasah) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->surat_memuat }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->surat_memuat) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ $data->email . '/perpanjangan/' . $data->stlk }}
                        </h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        <object width="100%" height="400px"
                            data="{{ asset($data->email . '/perpanjangan/' . $data->stlk) }}"></object>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">
                                Close
                            </button>
