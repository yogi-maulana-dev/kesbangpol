                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="sign_in" role="tabpanel">
                        <form action="{{route('admin.berita.update')}}" method="POST" class="md-float-material form-material" enctype="multipart/form-data">
                            ...
                            <input type="text" name="berita" value="{{ $berita->id }}">
                            <div class="form-group">
                                <input type="text" name="title" id="title" class="form-control @error('title') is-valid @enderror" required="" value="{{ $berita->title }}">
                            ...
                            <div class="form-group">
                                <input type="text" name="slug" id="slug" class="form-control @error('slug') is-valid @enderror" required="">
                                <span class="form-bar"></span>
                            ...
                            <div class="form-group form-primary">
                                ...
                                <input type="text" name="filegambar" value="{{ $berita->gambar }}">
                            ...
                            <div class="form-group form-primary">
                                ...
                                <textarea class="form-control @error('body') is-valid @enderror editor" rows="100" cols="300" id="edit{{ $berita->id }}" name="body">{{ $berita->body }} {{ $berita->id }}</textarea>
                                <div class="invalid-feedback">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="sign_in" role="tabpanel">
                        <form action="{{ route('admin.berita.store') }}" method="POST" class="md-float-material form-material" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" name="slug" id="slug" class="form-control @error('slug') is-valid @enderror" required="" value="{{ old('slug') }}">
                                <span class="form-bar"></span>
                                <label class="float-label">Slug</label>
                                @error('slug')
                                <div class="invalid-feedback">
