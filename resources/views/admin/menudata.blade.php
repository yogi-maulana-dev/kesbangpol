                ...
                <table id="new-cons" class="table table-striped table-bordered nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <button class="btn waves-effect waves-dark btn-primary btn-outline-primary badge bg-info" data-target="#tabbed-form-{{ $data->id }}" data-titleku="DataOrkemas" data-toggle="modal"><span data-feather="eye"></span></button>
                            ...
                            <td>
                                <a href="{{ route('admin.download', $data->nama) }}" target="_blank" rel="noopener" class="btn btn-success btn-sm text-white">
                                    Download
                                </a>
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs md-tabs nav-justified" role="tablist">
                    <li class="nav-item waves-effect waves-dark">
                        <a class="nav-link active" data-toggle="tab" href="#{{$data->surat_terdaftar_dikemenkumham}}" role="tab">
                ...
                <div class="tab-content p-t-30">
                    <div class="tab-pane active" id="{{$data->surat_terdaftar_dikemenkumham}}" role="tabpanel">
                        ...
                        <form method="post" action="{{route('admin.menudata.update')}}" class="float-material form-material" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center"><label class="label label-inverse-primary"><span data-feather="loader"></span>{{
                                            $data->surat_terdaftar_dikemenkumham
                                            }}</label>
                                    </p>

                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#surat_terdaftar_dikemenkumham-{{$data->id}}">Lihat
                                            Data
                                        </a>
                                    </p>
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_terdaftar_dikemenkumham" name="a_surat_terdaftar_dikemenkumham" value="2" {{
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_terdaftar_dikemenkumham" name="a_surat_terdaftar_dikemenkumham" value="0" {{
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->surat_terdaftar_dikemenkumham) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_terdaftar_dikemenkumham }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->surat_terdaftar_dikemenkumham) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#surat_pendaftaran-{{$data->id}}">Lihat
                                            Data
                                        </a>
                                    </p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_pendaftaran" name="a_surat_pendaftaran" value="2" {{
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_pendaftaran" name="a_surat_pendaftaran" value="0" {{
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->surat_pendaftaran) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_pendaftaran }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->surat_pendaftaran) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#program-{{$data->id}}">Lihat
                                            Data
                                        </a>
                                    </p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_program" name="a_program" value="2" {{ ($data->a_program == 2 ?
                                                        'checked' :
                                                        '')}}>
                                                            <span class="cr">
                                                                <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_program" name="a_program" value="0" {{ ($data->a_program == 0 ?
                                                        'checked' :
                                                        '')}}>
                                                            <span class="cr">
                                                                <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->program) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->program }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->program) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#adrt-{{ $data->id }}">Lihat
                                            Data
                                        </a>
                                    </p>
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->adrt) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->adrt }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->adrt) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#akte_pendirian-{{$data->id}}">Lihat
                                            Data
                                        </a>
                                    </p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_akte_pendirian" name="a_akte_pendirian" value="2" {{
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_akte_pendirian" name="a_akte_pendirian" value="0" {{
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->akte_pendirian) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->akte_pendirian }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->akte_pendirian) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#keabsahan_kantor-{{ $data->id }}">Lihat
                                            Data
                                        </a>
                                    </p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_keabsahan_kantor" name="a_keabsahan_kantor" value="2" {{
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_keabsahan_kantor" name="a_keabsahan_kantor" value="0" {{
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->keabsahan_kantor) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->keabsahan_kantor }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->keabsahan_kantor) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    <p class="text-muted text-center">
                                        <a class="btn btn-primary" data-toggle="modal" href="#surat_keputusan-{{ $data->id }}">Lihat
                                            Data
                                        </a>
                                    </p>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <p class="text-muted text-center">
                                                <div class="col-sm-12">
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_keputusan" name="a_surat_keputusan" value="2" {{
                                                    ...
                                                    <div class="checkbox-fade fade-in-primary">
                                                        <label>
                                                            <input type="checkbox" id="a_surat_keputusan" name="a_surat_keputusan" value="0" {{
                                ...
                                <div class="p-20 z-depth-bottom-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset($data->nama . '/' . $data->surat_keputusan) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_keputusan }}">

                                                    <img src="{{ asset($data->nama . '/' . $data->surat_keputusan) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                    ...
                    <div class="tab-pane" id="{{$data->surat_pendaftaran}}" role="tabpanel">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#biodata_pengurus-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_biodata_pengurus" name="a_biodata_pengurus" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_biodata_pengurus" name="a_biodata_pengurus" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->biodata_pengurus) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->biodata_pengurus }}">

                                                <img src="{{ asset($data->nama . '/' . $data->biodata_pengurus) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->ktp) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->ktp }}">

                                                <img src="{{ asset($data->nama . '/' . $data->ktp) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->foto) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->foto }}">

                                                <img src="{{ asset($data->nama . '/' . $data->foto) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_keterangan_domisili-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_keterangan_domisili" name="a_surat_keterangan_domisili" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_keterangan_domisili" name="a_surat_keterangan_domisili" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_keterangan_domisili) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_keterangan_domisili }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_keterangan_domisili) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->npwp) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->npwp }}">

                                                <img src="{{ asset($data->nama . '/' . $data->npwp) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#foto_kantor-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_foto_kantor" name="a_foto_kantor" value="2" {{ ($data->a_foto_kantor == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_foto_kantor" name="a_foto_kantor" value="0" {{ ($data->a_foto_kantor == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->foto_kantor) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->foto_kantor }}">

                                                <img src="{{ asset($data->nama . '/' . $data->foto_kantor) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_absah-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_absah" name="a_surat_absah" value="2" {{ ($data->a_surat_absah == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_absah" name="a_surat_absah" value="0" {{ ($data->a_surat_absah == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_absah) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_absah }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_absah) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_rekom_kesediaan-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_kesediaan" name="a_surat_rekom_kesediaan" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_kesediaan" name="a_surat_rekom_kesediaan" value="0" {{
                        ...
                        {{-- buka JPG --}}
                        @elseif($surat_rekom_kesediaan == 'png' or $surat_rekom_kesediaan
                        == 'jpg')
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_rekom_kesediaan) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_rekom_kesediaan }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_rekom_kesediaan) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                    ...
                    <div class="tab-pane" id="{{$data->akte_pendirian}}" role="tabpanel">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_ketertiban-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_ketertiban" name="a_surat_ketertiban" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_ketertiban" name="a_surat_ketertiban" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_ketertiban) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_ketertiban }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_ketertiban) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_tidak_avilasi-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_tidak_avilasi" name="a_surat_tidak_avilasi" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_tidak_avilasi" name="a_surat_tidak_avilasi" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_tidak_avilasi) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_tidak_avilasi }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_tidak_avilasi) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_konflik-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_konflik" name="a_surat_konflik" value="2" {{ ($data->a_surat_konflik == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_konflik" name="a_surat_konflik" value="0" {{ ($data->a_surat_konflik == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_konflik) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_konflik }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_konflik) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_hak_cipta-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_hak_cipta" name="a_surat_hak_cipta" value="2" {{ ($data->a_surat_hak_cipta
                                                    == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_hak_cipta" name="a_surat_hak_cipta" value="0" {{ ($data->a_surat_hak_cipta
                                                    == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_hak_cipta) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_hak_cipta }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_hak_cipta) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_laporan-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_laporan" name="a_surat_laporan" value="2" {{ ($data->a_surat_laporan == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_laporan" name="a_surat_laporan" value="0" {{ ($data->a_surat_laporan == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_laporan) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_laporan }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_laporan) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_rekom_agama-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_agama" name="a_surat_rekom_agama" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_agama" name="a_surat_rekom_agama" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_rekom_agama) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_rekom_agama }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_rekom_agama) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_rekom_skpd-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_skpd" name="a_surat_rekom_skpd" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_skpd" name="a_surat_rekom_skpd" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_rekom_skpd) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_rekom_skpd }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_rekom_skpd) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                    ...
                    <div class="tab-pane" id="{{$data->adrt}}" role="tabpanel">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_rekom_skpd_kerja-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_skpd_kerja" name="a_surat_rekom_skpd_kerja" value="2" {{
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_rekom_skpd_kerja" name="a_surat_rekom_skpd_kerja" value="0" {{
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_rekom_skpd_kerja) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_rekom_skpd_kerja }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_rekom_skpd_kerja) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                <p class="text-muted text-center">
                                    <a class="btn btn-primary" data-toggle="modal" href="#surat_izasah-{{ $data->id }}">Lihat
                                        Data
                                    </a>
                                </p>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="text-muted text-center">
                                            <div class="col-sm-12">
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_izasah" name="a_surat_izasah" value="2" {{ ($data->a_surat_izasah == 2 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                                ...
                                                <div class="checkbox-fade fade-in-primary">
                                                    <label>
                                                        <input type="checkbox" id="a_surat_izasah" name="a_surat_izasah" value="0" {{ ($data->a_surat_izasah == 0 ?
                                                    'checked' :
                                                    '')}}>
                                                        <span class="cr">
                                                            <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->surat_izasah) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->surat_izasah }}">

                                                <img src="{{ asset($data->nama . '/' . $data->surat_izasah) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                            ...
                            <div class="p-20 z-depth-bottom-1">
                                ...
                                */ --}}
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset($data->nama . '/' . $data->skt) }}" data-lightbox="1" data-title="{{ $data->nama . '/' . $data->skt }}">

                                                <img src="{{ asset($data->nama . '/' . $data->skt) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title="" data-original-title=".z-depth-top-1">
                                ...
                                <div class="form-group form-primary">
                                    <textarea rows="10" cols="5" class="form-control" name="ket" placeholder="Keterangan"></textarea>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <button type="submit" class="btn waves-effect waves-light hor-grd btn-grd-success">Simpan
                                    Data</button>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    scrolling="auto"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_terdaftar_dikemenkumham) }}"></object>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    scrolling="auto"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_pendaftaran) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    scrolling="auto"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->akte_pendirian) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    scrolling="auto"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->keabsahan_kantor) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_keputusan-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_keputusan) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="biodata_pengurus-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->biodata_pengurus) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_keterangan_domisili-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_keterangan_domisili) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_ketertiban-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_ketertiban) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_tidak_avilasi-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_tidak_avilasi) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_konflik-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_konflik) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_hak_cipta-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_hak_cipta) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_laporan-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_laporan) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_rekom_agama-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_rekom_agama) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_rekom_skpd-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_rekom_skpd) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_rekom_skpd_kerja-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_rekom_skpd_kerja) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_rekom_kesediaan-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_rekom_kesediaan) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
...
<div id="surat_izasah-{{$data->id}}" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <object width="100%" height="400px" data="{{ asset($data->nama . '/' . $data->surat_izasah) }}"></object>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">
                        Close
                    </button>
