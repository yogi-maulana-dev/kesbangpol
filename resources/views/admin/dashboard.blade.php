                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset($data->nama . '/' . $data->adrt) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ $data->nama . '/' . $data->adrt }}">

                                                                    <img src="{{ asset($data->nama . '/' . $data->adrt) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                                                </a>
                                                    ...
                                                    <div class="thumbnail">
                                                        <div class="thumb">
                                                            <a href="{{ asset($data->nama . '/' . $data->ktp) }}"
                                                                ...
                                                                <img src="{{ asset($data->nama . '/' . $data->ktp) }}"
                                                    ...
                                                    <div class="thumbnail">
                                                        <div class="thumb">
                                                            <a href="{{ asset($data->nama . '/' . $data->foto) }}"
                                                                ...
                                                                <img src="{{ asset($data->nama . '/' . $data->foto) }}"
                                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                                    style="max-height: 200px;">
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="thumbnail">
                                                        <div class="thumb">
                                                            <a href="{{ asset($data->nama . '/' . $data->npwp) }}"
                                                                ...
                                                                <img src="{{ asset($data->nama . '/' . $data->npwp) }}"
                                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                                    style="max-height: 200px;">
                                                            </a>
                                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top"
                                            ...
                                            <div class="col-lg-12 col-sm-12">
                                                <div class="thumbnail">
                                                    <div class="thumb">
                                                        <a href="{{ asset($data->nama . '/' . $data->skt) }}"
                                                            data-lightbox="1"
                                                            data-title="{{ $data->nama . '/' . $data->skt }}">
                                                            <img src="{{ asset($data->nama . '/' . $data->skt) }}"
                                                                alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                                style="max-height: 200px;">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumb">
                                                        <a href="{{ asset($data->nama . '/' . $data->tujuan) }}"
                                                            ...
                                                            <img src="{{ asset($data->nama . '/' . $data->tujuan) }}"
                                                                alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                                style="max-height: 200px;">
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumb">
                                                        <a href="{{ asset($data->nama . '/' . $data->program) }}"
                                                            ...
                                                            <img src="{{ asset($data->nama . '/' . $data->program) }}"
                                                                alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                                style="max-height: 200px;">
                                                        </a>
                                                    </div>
