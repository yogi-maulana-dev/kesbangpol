    ...
    <div class="card-block">
        <form method="post" action="/data" class="form-material" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="file" name="keabsahan_kantor" class="form-control @error('keabsahan_kantor') is-invalid @enderror">
                            ...
                            <div class="col-lg-12">
                                <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title="" data-original-title=".z-depth-top-1">
                                    <p class="text-muted text-center p-b-5">
                                        ...
                                        <label class="label label-inverse-success"><span data-feather="check-circle"></span>{{ $data->keabsahan_kantor }}</label>
                                        @else
                                        @endif
                                    </p>
                                ...
                                <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title="" data-original-title=".z-depth-top-1">
                                    ...
                                    */ --}}
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="thumbnail">
                                            <div class="thumb">
                                                <a href="{{ asset(auth()->user()->nama . '/' . $data->keabsahan_kantor) }}" data-lightbox="1" data-title="{{ auth()->user()->nama . '/' . $data->keabsahan_kantor }}">
                                                    <img src="{{ asset(auth()->user()->nama . '/' . $data->keabsahan_kantor) }}" alt="" class="img-fluid img-thumbnail mx-auto d-block" style="max-height: 200px;">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            scrolling="auto"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                <object width="100%" height="400px" data="{{ asset(auth()->user()->nama . '/' . $data->keabsahan_kantor) }}"></object>
                <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/keabsahan_kantor20220416012844.pdf"
