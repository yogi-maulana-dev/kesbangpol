...
@section('home')
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="hero d-flex p-1 align-items-center">

        <div class="container kepala">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Selamat datang
                        <h2 data-aos="fade-up" data-aos-delay="400">Pada aplikasi registrasi Organisasi Masyarakat,
                            Silakan lihat video dibawah ini, cara pendaftaran</h2>
                ...
                <div class="row">
                        ...
                        @if ($beritas->count())
                            @foreach ($beritas as $berita)
                                <article class="entry">
                                    ...
                                    <div class="entry-img">
                                        <img src="{{ asset('gambarberita/' . $berita->gambar) }}" alt=""
                                            class="img-fluid">
                                    </div>

                                    <h2 class="entry-title">
                                        <a href="/home/{{ $berita->slug }}"> {{ $berita->title }}</a>
                                    ...
                                    <div class="entry-meta">
                                        <ul>
                                            <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                                    href="/home/{{ $berita->slug }}"><time
                                                        datetime="{{ $berita->created_at }}">{{ $berita->created_at }}</time></a>
                                            </li>
                                            <li class="d-flex align-items-center"><i class="bi bi-text-paragraph"></i> <a
                                                    href="/categori/{{ $berita->categori->id }}">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="read-more">
                                            <a href="/home/{{ $berita->slug }}">Baca Lengkap...</a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar">
                            ...
                            <h3 class="sidebar-title">Categori</h3>
                            <div class="sidebar-item categories">
                                <ul>
                                    @foreach ($categoris as $categori)
                                        <li><a href="/categori/{{ $categori->id }}">{{ $categori->name }}<span>

                                                    @php $arrayjumlah = array(); @endphp
                                                    @foreach ($categori->home->where('categori_id') as $jumlah)
