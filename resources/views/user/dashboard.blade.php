                                        ...
                                        @if ($datas->isEmpty())
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <form method="post" action="/data" class="form-material"
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">13. Surat Pernyataan
                                                                ...
                                                                (Di Tanda Tangani Ketua Dan Sekretaris)  5. Surat Pernyataan Tidak Berafiliasi Dengan Partai Politik</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-3 col-form-label">16. Surat Rekomendasi
                                                                ...
                                                                kerja orkemas serikat buruh ( boleh di isi atau tidak)</label>
                                                            <div class="col-sm-8">
                                ...
                                @else
									...
									*/ --}}
                                                                                <div class="col-lg-12 col-sm-12">
                                                                                    <div class="thumbnail">
                                                                                        <div class="thumb">
                                                                                            <a href="{{ asset(auth()->user()->email . '/' . $data->tujuan) }}"
                                                                                                data-lightbox="1"
                                                                                                data-title="{{ auth()->user()->email . '/' . $data->tujuan }}">

                                                                                                <img src="{{ asset(auth()->user()->email . '/' . $data->tujuan) }}"
                                                                                                    alt=""
                                                                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                                                                    style="max-height: 200px;">
                                                                                            </a>
									...
									*/ --}}
                                                                                <div class="col-lg-12 col-sm-12">
                                                                                    <div class="thumbnail">
                                                                                        <div class="thumb">
                                                                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_memuat) }}"
                                                                                                data-lightbox="1"
                                                                                                data-title="{{ auth()->user()->email . '/' . $data->surat_memuat }}">

                                                                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_memuat) }}"
                                                                                                    alt=""
                                                                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                                                                    style="max-height: 200px;">
                                                                                            </a>
									...
									*/ --}}
                                                                                <div class="col-lg-12 col-sm-12">
                                                                                    <div class="thumbnail">
                                                                                        <div class="thumb">
                                                                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kepercayaan) }}"
                                                                                                data-lightbox="1"
                                                                                                data-title="{{ auth()->user()->email . '/' . $data->surat_rekom_skpd_kepercayaan }}">

                                                                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kepercayaan) }}"
                                                                                                    alt=""
                                                                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                                                                    style="max-height: 200px;">
                                                                                            </a>
									...
									*/ --}}
                                                                                <div class="col-lg-12 col-sm-12">
                                                                                    <div class="thumbnail">
                                                                                        <div class="thumb">
                                                                                            <a href="{{ asset(auth()->user()->email . '/' . $data->stlk) }}"
                                                                                                data-lightbox="1"
                                                                                                data-title="{{ auth()->user()->email . '/' . $data->stlk }}">

                                                                                                <img src="{{ asset(auth()->user()->email . '/' . $data->stlk) }}"
                                                                                                    alt=""
                                                                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                                                                    style="max-height: 200px;">
                                                                                            </a>
									...
									*/ --}}
                                                                                <div class="col-lg-12 col-sm-12">
                                                                                    <div class="thumbnail">
                                                                                        <div class="thumb">
                                                                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_kemenkumham) }}"
                                                                                                data-lightbox="1"
                                                                                                data-title="{{ auth()->user()->email . '/' . $data->surat_kemenkumham }}">

                                                                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_kemenkumham) }}"
                                                                                                    alt=""
                                                                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                                                                    style="max-height: 200px;">
                                                                                            </a>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_pendaftaran }}
                                                    </h4>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->akte_pendirian }} </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                              type="application/pdf"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->keabsahan_kantor }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_keputusan }} </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->biodata_pengurus }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_keterangan_domisili }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->foto_kantor }} </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                      type="application/pdf"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_ketertiban }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_rekom_agama }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_rekom_skpd_kepercayaan }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                                                                                                                                     /> -->
                                                    <object width="100%" height="400px"
                                                        data="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kepercayaan) }}"></object>
                                                    <!--
                                                                                                                                                                                                                                                                                                                                                                                                                     <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                      type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                      src="http://127.0.0.1:8000/yrka1234/surat_rekom_skpd20220416012844.pdf"
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_rekom_kesediaan }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">
                                                        {{ auth()->user()->email . '/' . $data->surat_izasah }} </h4>
                                                </div>
                                                <div class="modal-body">
                                                    <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                     type="application/pdf"
