                                ...
                                <div class="tab-pane active" id="data1" role="tabpanel">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->surat_terdaftar_dikemenkumham) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->surat_terdaftar_dikemenkumham }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->surat_terdaftar_dikemenkumham) }}"
                                                                            alt=""
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->surat_pendaftaran) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->surat_pendaftaran }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->surat_pendaftaran) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->akte_pendirian) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->akte_pendirian }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->akte_pendirian) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        <p class="text-muted text-center p-b-5">
                                                            <a data-toggle="modal" href="#adrt"
                                                                class="btn btn-primary">Lihat Data
                                                            </a>
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->adrt) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->adrt }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->adrt) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                            ...
                                            @elseif ($surat_keputusan == 'png' or $surat_keputusan == 'jpg')
                                                <div class="col-lg-12">
                                                    <div class="p-2 z-depth-bottom-1" data-toggle="tooltip"
                                                        data-placement="top" title="" data-original-title=".z-depth-top-1">
                                                        @if ($data->a_surat_keputusan == 0)
                                                            <p class="text-muted text-center p-b-5">
                                                                <label class="label label-inverse-primary"><span
                                                                        data-feather="loader"></span>{{ $data->surat_keputusan }}</label>
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->surat_keputusan) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->surat_keputusan }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->surat_keputusan) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->biodata_pengurus) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->biodata_pengurus }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->biodata_pengurus) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                ...
                                <div class="tab-pane" id="data2" role="tabpanel">
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->ktp) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->ktp }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->ktp) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->foto) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->foto }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->foto) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->surat_keterangan_domisili) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->surat_keterangan_domisili }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->surat_keterangan_domisili) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->npwp) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->npwp }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->npwp) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                    ...
                                    */ --}}
                                                        ...
                                                        <div class="col-lg-12 col-sm-12">
                                                            <div class="thumbnail">
                                                                <div class="thumb">
                                                                    <a href="{{ asset(auth()->user()->email . '/' . $data->foto_kantor) }}"
                                                                        data-lightbox="1"
                                                                        data-title="{{ auth()->user()->email . '/' . $data->foto_kantor }}">

                                                                        <img src="{{ asset(auth()->user()->email . '/' . $data->foto_kantor) }}"
                                                                            alt=""
                                                                            class="img-fluid img-thumbnail mx-auto d-block"
                                                                            style="max-height: 200px;">
                                                                    </a>
                                ...
                                @foreach ($datas as $data)
                                    ...
                                    */ --}}
                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset(auth()->user()->email . '/' . $data->surat_ketertiban) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ auth()->user()->email . '/' . $data->surat_ketertiban }}">

                                                                    <img src="{{ asset(auth()->user()->email . '/' . $data->surat_ketertiban) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset(auth()->user()->email . '/' . $data->surat_tidak_avilasi) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ auth()->user()->email . '/' . $data->surat_tidak_avilasi }}">

                                                                    <img src="{{ asset(auth()->user()->email . '/' . $data->surat_tidak_avilasi) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset(auth()->user()->email . '/' . $data->surat_konflik) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ auth()->user()->email . '/' . $data->surat_konflik }}">

                                                                    <img src="{{ asset(auth()->user()->email . '/' . $data->surat_konflik) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                                                </a>
                                    ...
                                    */ --}}
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset(auth()->user()->email . '/' . $data->surat_hak_cipta) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ auth()->user()->email . '/' . $data->surat_hak_cipta }}">

                                                                    <img src="{{ asset(auth()->user()->email . '/' . $data->surat_hak_cipta) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                                    ...
                                    */ --}}
                                                    ...
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="thumbnail">
                                                            <div class="thumb">
                                                                <a href="{{ asset(auth()->user()->email . '/' . $data->surat_laporan) }}"
                                                                    data-lightbox="1"
                                                                    data-title="{{ auth()->user()->email . '/' . $data->surat_laporan }}">

                                                                    <img src="{{ asset(auth()->user()->email . '/' . $data->surat_laporan) }}"
                                                                        alt=""
                                                                        class="img-fluid img-thumbnail mx-auto d-block"
                                                                        style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_absah) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_absah }}">

                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_absah) }}"
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_agama) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_rekom_agama }}">
                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_agama) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_rekom_skpd }}">

                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja }}">
                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_kesediaan) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_rekom_kesediaan }}">

                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_kesediaan) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->surat_izasah) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->surat_izasah }}">

                                                <img src="{{ asset(auth()->user()->email . '/' . $data->surat_izasah) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->skt) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->skt }}">
                                                <img src="{{ asset(auth()->user()->email . '/' . $data->skt) }}" alt=""
                                                    class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->keabsahan_kantor) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->keabsahan_kantor }}">
                                                <img src="{{ asset(auth()->user()->email . '/' . $data->keabsahan_kantor) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="p-2 z-depth-bottom-1" data-toggle="tooltip" data-placement="top" title=""
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="thumbnail">
                                        <div class="thumb">
                                            <a href="{{ asset(auth()->user()->email . '/' . $data->program) }}"
                                                data-lightbox="1"
                                                data-title="{{ auth()->user()->email . '/' . $data->program }}">
                                                <img src="{{ asset(auth()->user()->email . '/' . $data->program) }}"
                                                    alt="" class="img-fluid img-thumbnail mx-auto d-block"
                                                    style="max-height: 200px;">
                                            </a>
                                        </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            {{ auth()->user()->email . '/' . $data->surat_terdaftar_dikemenkumham }}</h4>
                        </h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_terdaftar_dikemenkumham) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/akte_pendirian20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_pendaftaran }}</h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_pendaftaran) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/akte_pendirian20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->akte_pendirian }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->akte_pendirian) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/akte_pendirian20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->adrt }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->adrt) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/adrt20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->keabsahan_kantor }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->keabsahan_kantor) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/keabsahan_kantor20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->program }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->program) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/program20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_keputusan }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_keputusan) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        src="http://127.0.0.1:8000/yrka1234/surat_keputusan20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->biodata_pengurus }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->biodata_pengurus) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    src="http://127.0.0.1:8000/yrka1234/biodata_pengurus20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->ktp }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->ktp) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    src="http://127.0.0.1:8000/yrka1234/ktp20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->foto }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->foto) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/foto20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->npwp }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->npwp) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/npwp20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_keterangan_domisili }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_keterangan_domisili) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    src="http://127.0.0.1:8000/yrka1234/surat_keterangan_domisili20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->foto_kantor }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->foto_kantor) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/foto_kantor20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_ketertiban }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_ketertiban) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    src="http://127.0.0.1:8000/yrka1234/surat_ketertiban20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_tidak_avilasi }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_tidak_avilasi) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_tidak_avilasi20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_konflik }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_konflik) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_konflik20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_hak_cipta }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_hak_cipta) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_hak_cipta20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_laporan }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_laporan) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_laporan20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_absah }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_absah) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_absah20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_rekom_agama }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_agama) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_rekom_agama20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_rekom_skpd }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                src="http://127.0.0.1:8000/yrka1234/surat_rekom_skpd20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_skpd_kerja) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/surat_rekom_skpd_kerja20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_rekom_kesediaan }}
                        </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_rekom_kesediaan) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/surat_rekom_kesediaan20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->surat_izasah }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->surat_izasah) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/surat_izasah20220416012844.pdf"
            ...
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ auth()->user()->email . '/' . $data->skt }} </h4>
                    </div>
                    <div class="modal-body">
                        <!-- <embed
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          /> -->
                        <object width="100%" height="400px"
                            data="{{ asset(auth()->user()->email . '/' . $data->skt) }}"></object>
                        <!--
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <iframe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            type="application/pdf"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            src="http://127.0.0.1:8000/yrka1234/skt20220416012844.pdf"
