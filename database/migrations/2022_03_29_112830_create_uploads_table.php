    ...
    public function up()
    {
        Schema::create('uploads', function (Blueprint $table) {
            $table->id();
             ...
             $table->enum('a_surat_pendaftaran',['0','1']);
        $table->string('akte_pendirian');
             $table->enum('a_akte_pendirian',['0','1']);
          $table->string('adrt');
           $table->enum('a_adrt',['0','1']);
                 $table->string('tujuan');
                $table->string('program');
                 $table->string('surat_keputusan');
                 $table->enum('a_surat_keputusan',['0','1']);
                  $table->string('biodata_pengurus');
                  $table->enum('a_biodata_pengurus',['0','1']);
                   $table->string('ktp');
                    $table->string('foto');
                     $table->string('surat_keterangan_domisili');
                     $table->enum('a_surat_keterangan_domisili' ,['0','1']);
                      $table->string('npwp');
                       $table->string('foto_kantor');
                        $table->string('surat_ketertiban');
                        $table->enum('a_surat_ketertiban',['0','1']);
                         $table->string('surat_tidak_avilasi');
                         $table->enum('a_surat_tidak_avilasi',['0','1']);
                         $table->string('surat_konflik');
                         $table->enum('a_surat_konflik',['0','1']);
                         $table->string('surat_hak_cipta');
                         $table->enum('a_surat_hak_cipta',['0','1']);
                         $table->string('surat_laporan');
                         $table->enum('a_surat_laporan',['0','1']);
                         $table->string('surat_absah');
                          $table->enum('a_surat_absah',['0','1']);
                         $table->string('surat_rekom_agama');
                         $table->enum('a_surat_rekom_agama',['0','1']);
                         $table->string('surat_rekom_skpd');
                         $table->enum('a_surat_rekom_skpd',['0','1']);
                         $table->string('surat_rekom_skpd_kerja');
                         $table->enum('a_surat_rekom_skpd_kerja' ,['0','1']);
                         $table->string('surat_rekom_kesediaan');
                         $table->enum('a_surat_rekom_kesediaan',['0','1']);
                         $table->string('surat_izasah');
                         $table->enum('a_surat_izasah',['0','1']);
                         $table->string('skt');
                         $table->enum('a_skt',['0','1']);
                         $table->timestamps();
